...
addr = r'D:\PycharmProjects\MyChatGLM2\raw_wechat_messages_datasets'

# 读取聊天记录
print(addr + '\message.csv')
message = pd.read_csv("D:\\PycharmProjects\\MyChatGLM2\\raw_wechat_messages_datasets\\message.csv", encoding='utf-8', low_memory=False)
...
# 读取联系人信息
friend = pd.read_csv(r'D:\PycharmProjects\MyChatGLM2\raw_wechat_messages_datasets\rcontact.csv', encoding='utf-8')
...
for k in chat.keys():
    ...
    with open('save\\'+ filename +'.csv', 'w', encoding='utf-8', newline='') as f:
        f_csv = csv.writer(f)
